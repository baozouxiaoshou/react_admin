        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <SubMenu
                        key="/app/myPanel"
                        title={<span><Icon type="customize" /><span className="nav-text">自定义</span></span>}
                    >
                        <Menu.Item key="/app/myPanel/myPanel"><Link to={'/app/myPanel/myPanel'}>测试环形进度</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu
                        key="/app/ui"
